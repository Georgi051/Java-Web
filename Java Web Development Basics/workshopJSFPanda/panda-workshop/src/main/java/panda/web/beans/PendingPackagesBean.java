...
public class PendingPackagesBean {
    ...
    private void initPackages() {
        this.packages = this.packageService.findAllPackagesByStatus(Status.Pending)
                .stream()
                .map(p ->{
    ...
    public void changeStatus(String id) throws IOException {
        ...
        FacesContext.getCurrentInstance().getExternalContext().redirect("/faces/view/pending.xhtml");
    }
}
