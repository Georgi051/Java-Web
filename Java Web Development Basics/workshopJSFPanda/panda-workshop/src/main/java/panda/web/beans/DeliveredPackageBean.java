...
public class DeliveredPackageBean {
    ...
    private void initPackages() {
        this.packages = this.packageService.findAllPackagesByStatus(Status.Delivered)
                .stream()
                .map(p ->{
    ...
    public void changeStatus(String id) throws IOException {
        ...
        FacesContext.getCurrentInstance().getExternalContext().redirect("/faces/view/delivered.xhtml");
    }
}
